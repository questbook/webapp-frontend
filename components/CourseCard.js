...
function CourseCard({ text, subtext, imgSrc, dimensions }) {
  return (
    <div className="flex flex-col items-center justify-center w-48 xl:w-72 h-72  xl:h-96 rounded-xl bg-gradient-to-t from-[#FEFEFE] to-[#F1F2FF]  shadow-[0_13px_22px_rgba(73,83,179,0.19)]">
