      ...
      <div className="container mx-auto relative h-full">
        ...
        <div className="absolute left-0  top-24 lg:top-20">
          <div className="relative w-[79px] lg:w-[213px] h-[76.9px] lg:h-[218px] -rotate-[8.45deg] drop-shadow-[5px_34px_52px_rgba(0,0,0,0.25)]">
            <Image alt="alt" src="/images/yc.png" layout="fill" />
          </div>
        </div>
        <div className="absolute left-24 bottom-0 lg:left-64 z-10 ">
        ...
        <div className="absolute  left-[42%] bottom-[18%] lg:bottom-[24%]  ">
          <div className="relative w-[79.32px] lg:w-[214.08px] h-[77px] lg:h-[218px]   drop-shadow-[5px_34px_52px_rgba(0,0,0,0.25)]">
            <Image alt="alt" src="/images/polygon.png" layout="fill" />
          </div>
        </div>
        <div className="absolute right-24 bottom-0  lg:right-56 z-10 ">
        ...
        <div className="absolute right-0  top-24 lg:top-20">
          <div className="relative w-[71.57px] lg:w-[213px] h-[69px] lg:h-[218px]  -rotate-[14.43deg]  drop-shadow-[5px_34px_52px_rgba(0,0,0,0.25)]">
            <Image alt="alt" src="/images/near_p.png" layout="fill" />
          </div>
        </div>
      </div>
    </section>
